...
INTRINS_OVR_2_ARG(AARCH64_UDOT_V64, aarch64_neon_udot, LLVMVectorType (LLVMInt32Type (), 2), LLVMVectorType (LLVMInt8Type (), 8))
INTRINS_OVR_2_ARG(AARCH64_UDOT_V128, aarch64_neon_udot, LLVMVectorType (LLVMInt32Type (), 4), LLVMVectorType (LLVMInt8Type (), 16))
INTRINS_OVR_2_ARG(AARCH64_SDOT_V64, aarch64_neon_sdot, LLVMVectorType (LLVMInt32Type (), 2), LLVMVectorType (LLVMInt8Type (), 8))
INTRINS_OVR_2_ARG(AARCH64_SDOT_V128, aarch64_neon_sdot, LLVMVectorType (LLVMInt32Type (), 4), LLVMVectorType (LLVMInt8Type (), 16))
